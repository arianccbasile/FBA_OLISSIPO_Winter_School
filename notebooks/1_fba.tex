...
\begin{Verbatim}[commandchars=\\\{\}]
<Model iMM904 at 0x7fad1b46a1f0>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Reaction 13BGHe at 0x7fad4ac12400>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Reaction PGI at 0x7fad4b4d2b20>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Metabolite atp\_c at 0x7fad48771a90>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Gene YBR196C at 0x7fad4ab617c0>
\end{Verbatim}
\end{tcolorbox}
...
YCR034W, new growth rate -0.000000
    ...
    Let's see the distribution of our results creating a histogram plot with
the vectors obtained above:
...
\end{tcolorbox}
    ...
    Let's try a different visualization, this time we will create a big
scatter plot showing the growth rate of each gene-knockout.
...
\PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{340}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{margins}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+m+mf}{0.001}\PY{p}{)} 
\PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{rotation}\PY{o}{=}\PY{l+m+mi}{90}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{scatter.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{,} \PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tight}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{pad\PYZus{}inches}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
    ...
    Since the generate plot is very wide, it will appear as a blank box.
Double click on it to expand it, then you can scroll to the right to
inspect gene-knockout-induced changes in growth rate.
...
\PY{c+c1}{\PYZsh{} From the results of the simulations above, we can see that YJL167W is an essential gene}
\PY{c+c1}{\PYZsh{} Let\PYZsq{}s check with genes.get\PYZus{}by\PYZus{}id and identify the reactions catalysed by this enzyme}
\PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{genes}\PY{o}{.}\PY{n}{get\PYZus{}by\PYZus{}id}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{YJL167W}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<Gene YJL167W at 0x7fad4e809fa0>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} When we selectively knockout the reaction GRTT we get no growth}
\PY{k}{with} \PY{n}{model\PYZus{}yeast} \PY{k}{as} \PY{n}{model\PYZus{}yeast}\PY{p}{:}
    \PY{n}{grtt} \PY{o}{=} \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{reactions}\PY{o}{.}\PY{n}{get\PYZus{}by\PYZus{}id}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{GRTT}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{grtt}\PY{o}{.}\PY{n}{knock\PYZus{}out}\PY{p}{(}\PY{p}{)}
    \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{optimize}\PY{p}{(}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{ blocked (bounds: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{), new growth rate }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}}
            \PY{p}{(}\PY{n}{grtt}\PY{o}{.}\PY{n}{id}\PY{p}{,} \PY{n+nb}{str}\PY{p}{(}\PY{n}{grtt}\PY{o}{.}\PY{n}{bounds}\PY{p}{)}\PY{p}{,} \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{objective}\PY{o}{.}\PY{n}{value}\PY{p}{)}\PY{p}{)}
    
\PY{c+c1}{\PYZsh{} When we selectively knockout the reaction DMATT, we get no growth}
\PY{k}{with} \PY{n}{model\PYZus{}yeast} \PY{k}{as} \PY{n}{model\PYZus{}yeast}\PY{p}{:}
    \PY{n}{dmatt} \PY{o}{=} \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{reactions}\PY{o}{.}\PY{n}{get\PYZus{}by\PYZus{}id}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{DMATT}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{dmatt}\PY{o}{.}\PY{n}{knock\PYZus{}out}\PY{p}{(}\PY{p}{)}
    \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{optimize}\PY{p}{(}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{ blocked (bounds: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{), new growth rate }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}}
            \PY{p}{(}\PY{n}{dmatt}\PY{o}{.}\PY{n}{id}\PY{p}{,} \PY{n+nb}{str}\PY{p}{(}\PY{n}{dmatt}\PY{o}{.}\PY{n}{bounds}\PY{p}{)}\PY{p}{,} \PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{objective}\PY{o}{.}\PY{n}{value}\PY{p}{)}\PY{p}{)}
    
\PY{c+c1}{\PYZsh{} Final manual check that knocking out this gene results in no growth}
\PY{n}{gene}\PY{o}{=}\PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{genes}\PY{o}{.}\PY{n}{get\PYZus{}by\PYZus{}id}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{YJL167W}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{gene}\PY{o}{.}\PY{n}{knock\PYZus{}out}\PY{p}{(}\PY{p}{)}
\PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{optimize}\PY{p}{(}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{YJL167W gene knocked out with new growth rate: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{model\PYZus{}yeast}\PY{o}{.}\PY{n}{objective}\PY{o}{.}\PY{n}{value}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
